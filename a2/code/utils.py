...
def plot_4class_classifier(model, X, y):
    """plots the decision boundary of the model and the scatterpoints
       of the target values 'y'.

    Assumptions
    -----------
    y : it should contain two classes: '0' and '1' and '2' and '3'
    ...
    plt.scatter(x1[y==0], x2[y==0], color="b", label="class 0")
    plt.scatter(x1[y==1], x2[y==1], color="r", label="class 1")
    plt.scatter(x1[y==2], x2[y==2], color="black", label="class 2")
    plt.scatter(x1[y==3], x2[y==3], color="w", label="class 3")
    plt.legend()
